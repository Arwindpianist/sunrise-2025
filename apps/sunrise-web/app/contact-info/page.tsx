        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
          ...
          <Card className="border-orange-200">
            ...
            <CardContent className="space-y-4">
              <div>
                <h3 className="font-semibold text-foreground mb-2">SUNRISE SUNSET SERVICES</h3>
              ...
              <div>
                ...
                <div className="text-muted-foreground space-y-1">
                  ...
                  <p className="text-sm leading-relaxed">
                    Managed IT (MSP), IT hardware sales (new and refurbished), software and integrations, music production,
                    and IT consulting including construction technology. Malaysia.
                  </p>
                  <p>Founder: Arwin Kumar</p>
                  <p>Website: <a href="https://arwindpianist.com" target="_blank" rel="noopener noreferrer" className="text-orange-500 hover:text-orange-600">arwindpianist.com</a></p>
                </div>
              </div>
            </CardContent>
          </Card>
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="text-center">
                ...
                <h3 className="font-semibold text-foreground mb-2">Contact Management</h3>
                <p className="text-muted-foreground text-sm">
              ...
              <div className="text-center">
                ...
                <h3 className="font-semibold text-foreground mb-2">Multi-Channel Communication</h3>
                <p className="text-muted-foreground text-sm">
        ...
        <Card className="mb-12 border-red-200">
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                <h3 className="font-semibold text-foreground mb-3">Business Compliance</h3>
                <ul className="space-y-2 text-muted-foreground">
        ...
        <div className="text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <a href="/privacy" className="block p-4 bg-white/50 backdrop-blur-sm rounded-lg hover:bg-white/70 transition-colors">
              ...
              <p className="text-muted-foreground text-sm">Learn how we protect your data and privacy</p>
            </a>
            ...
            <a href="/terms" className="block p-4 bg-white/50 backdrop-blur-sm rounded-lg hover:bg-white/70 transition-colors">
              ...
              <p className="text-muted-foreground text-sm">Read our terms and conditions of service</p>
            </a>
            ...
            <a href="/cookie-policy" className="block p-4 bg-white/50 backdrop-blur-sm rounded-lg hover:bg-white/70 transition-colors">
              ...
              <p className="text-muted-foreground text-sm">Understand how we use cookies and tracking</p>
            </a>
          </div>
        </div>
      </div>
