      ...
      <div className="w-full max-w-6xl grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
        ...
        <div className="hidden lg:block space-y-8">
          <div className="text-center lg:text-left">
            ...
            <h1 className="mb-4 text-4xl font-bold text-foreground">Start Your Journey</h1>
            <p className="text-xl text-muted-foreground">
              {isSunset ? "Join families and organisers communicating with care." : "Join thousands creating unforgettable celebrations."}
            </p>
          </div>
          ...
          <div className="space-y-6">
            <div className="flex items-start space-x-4">
              <div className={isSunset ? "bg-primary/15 rounded-full p-2" : "bg-orange-100 rounded-full p-2"}>
                <Calendar className={isSunset ? "h-5 w-5 text-primary" : "h-5 w-5 text-orange-500"} />
              </div>
              <div>
                <h3 className="font-semibold text-foreground">Guided Communication Setup</h3>
                <p className="text-muted-foreground">
                  {isSunset ? "Set up memorial communication flows in minutes with clear, respectful steps." : "Create beautiful events in minutes with our intuitive interface"}
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-4">
              <div className={isSunset ? "bg-primary/15 rounded-full p-2" : "bg-rose-100 rounded-full p-2"}>
                <Users className={isSunset ? "h-5 w-5 text-primary" : "h-5 w-5 text-rose-500"} />
              </div>
              <div>
                <h3 className="font-semibold text-foreground">Smart Contact Management</h3>
                <p className="text-muted-foreground">Organize family, community, and logistics contacts effortlessly.</p>
              </div>
            </div>

            <div className="flex items-start space-x-4">
              <div className={isSunset ? "bg-primary/15 rounded-full p-2" : "bg-amber-100 rounded-full p-2"}>
                <MessageSquare className={isSunset ? "h-5 w-5 text-primary" : "h-5 w-5 text-amber-500"} />
              </div>
              <div>
                <h3 className="font-semibold text-foreground">Timed Updates</h3>
                <p className="text-muted-foreground">Never miss sending important updates or follow-up messages.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <Card className="w-full max-w-md mx-auto">
          <CardHeader className="text-center">
            ...
            <p className="text-muted-foreground">Start your free account today</p>
          </CardHeader>
          <CardContent>
              ...
              <div className="space-y-4">
                <div className="flex items-center space-x-2">
                  ...
                  <Label htmlFor="terms" className="text-sm">
                    I agree to the{" "}
                    <Link href="/terms" className={isSunset ? "text-primary hover:underline" : "text-orange-500 hover:underline"}>
                      Terms of Service
                    </Link>{" "}
                    and{" "}
                    <Link href="/privacy" className={isSunset ? "text-primary hover:underline" : "text-orange-500 hover:underline"}>
                      Privacy Policy
                    </Link>
                  </Label>
                </div>
