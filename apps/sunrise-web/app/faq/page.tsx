...
export default function FAQPage() {
  ...
  return (
    <div className={isSunset ? "sunset-marketing min-h-screen bg-background" : "min-h-screen bg-gradient-to-br from-orange-50 via-rose-50 to-amber-50"}>
      {/* Header */}
      <div
        className={
          isSunset
            ? "sunset-panel border-b border-border bg-card/80 backdrop-blur-md"
            : "border-b border-border bg-card/80 backdrop-blur-md"
        }
      >
        <div className="container mx-auto px-4 py-16 text-center">
          <h1 className="mb-4 text-4xl font-bold text-foreground md:text-5xl">Frequently Asked Questions</h1>
          <p className="mx-auto max-w-3xl text-xl text-muted-foreground">
            Everything you need to know about {isSunset ? "Sunset" : "Sunrise"} pricing, features, and policies.
          </p>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="max-w-4xl mx-auto space-y-6">
          {filteredFAQs.map((faq, index) => (
              <Card key={index} className={isSunset ? "sunset-panel border-border bg-card/85 shadow-sm hover:shadow-md transition-shadow" : "shadow-sm hover:shadow-md transition-shadow"}>
              <CardHeader 
        ...
        <div className="mt-16">
          <div className="text-center mb-12">
            <h2 className="mb-4 text-3xl font-bold text-foreground">Compare Our Plans</h2>
            <p className="text-xl text-muted-foreground">
              Choose the perfect plan for your {isSunset ? "memorial communication" : "event management"} needs
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
            ...
            <Card className="relative">
              <CardHeader className="text-center">
                ...
                <div className="text-3xl font-bold text-foreground">RM0</div>
              ...
              <CardContent className="space-y-3">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm text-muted-foreground">Token purchasing</span>
                </div>
                <div className="flex items-center gap-2">
                  <X className="h-4 w-4 text-red-500" />
                  <span className="text-sm text-muted-foreground">Telegram messaging</span>
                </div>
              </CardContent>
            </Card>

            {/* Basic Tier */}
            <Card className={isSunset ? "relative border-2 border-primary/40" : "relative border-2 border-orange-200"}>
              <div className="absolute -top-3 left-1/2 transform -translate-x-1/2">
                <Badge className={isSunset ? "bg-primary text-primary-foreground" : "bg-orange-500 text-white"}>Popular</Badge>
              </div>
              <CardHeader className="text-center">
                <CardTitle className="text-xl">Basic</CardTitle>
                <div className="text-3xl font-bold text-foreground">RM9.90</div>
                <div className="text-muted-foreground">per month</div>
              </CardHeader>
              <CardContent className="space-y-3">
                <div className="flex items-center gap-2">
            ...
            {/* Pro Tier */}
            <Card className={isSunset ? "relative border-2 border-primary/40" : "relative border-2 border-rose-200"}>
              <div className="absolute -top-3 left-1/2 transform -translate-x-1/2">
                <Badge className={isSunset ? "bg-primary text-primary-foreground" : "bg-rose-500 text-white"}>Best Value</Badge>
              </div>
              <CardHeader className="text-center">
                <CardTitle className="text-xl">Pro</CardTitle>
                <div className="text-3xl font-bold text-foreground">RM29.90</div>
                <div className="text-muted-foreground">per month</div>
              </CardHeader>
              <CardContent className="space-y-3">
                <div className="flex items-center gap-2">
            ...
            <Card className="relative border-2 border-purple-200">
              ...
              <CardHeader className="text-center">
                ...
                <div className="text-3xl font-bold text-foreground">RM79.90</div>
                <div className="text-muted-foreground">per month</div>
              </CardHeader>
              <CardContent className="space-y-3">
                <div className="flex items-center gap-2">
        ...
        <div className="mt-16 text-center">
          <Card className={isSunset ? "sunset-panel max-w-4xl mx-auto border border-primary/35 bg-primary/12 text-foreground" : "max-w-4xl mx-auto bg-gradient-to-r from-orange-500 to-rose-500 text-white"}>
            <CardContent className="p-8">
              <h2 className="text-3xl font-bold mb-4">
                {isSunset ? "Ready to support your communication flow?" : "Ready to Transform Your Event Management?"}
              </h2>
              <p className={isSunset ? "text-xl mb-6 text-muted-foreground" : "text-xl mb-6 opacity-90"}>
                Join teams who've upgraded from free to paid plans. 
                  ...
                  <Button
                    ...
                    className={
                      isSunset
                        ...
                        : "bg-white text-orange-600 hover:bg-white/90 dark:bg-card dark:text-orange-400 dark:hover:bg-accent"
                    }
                  >
                    View All Plans
                  </Button>
                  ...
                  <Button
                    ...
                    className={
                      isSunset
                        ...
                        : "border-white bg-white text-orange-600 hover:bg-white/90 dark:border-border dark:bg-card dark:text-orange-400 dark:hover:bg-accent"
                    }
                  >
                    Start Free Trial
                  </Button>
