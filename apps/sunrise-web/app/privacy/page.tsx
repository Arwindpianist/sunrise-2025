    ...
    <div className={pageBg}>
      <div className="container mx-auto py-16 px-4">
        ...
        <div className={panel}>
          ...
          <p className={body}>
            This policy applies when you use <strong className={isSunset ? "text-foreground" : ""}>Sunrise</strong>,{" "}
            <strong className={isSunset ? "text-foreground" : ""}>Sunset</strong>, or related sites and services operated by{" "}
            <strong className={isSunset ? "text-foreground" : ""}>Sunrise Sunset Services</strong>. We are committed to
            protecting your privacy and ensuring your data is handled responsibly in compliance with the Personal Data
            Protection Act 2010 (PDPA) of Malaysia.
          </p>

          <div>
            <h2 className={h2}>1. Data Controller Information</h2>
            <div className={`${body} space-y-2`}>
              <p><strong className={isSunset ? "text-foreground" : ""}>Data Controller:</strong> Sunrise Sunset Services</p>
              <p><strong>Business Registration No:</strong> 202503184225 (CT0152300-K)</p>
              <p><strong>Business Type:</strong> Sole Proprietorship</p>
              <p><strong>Email:</strong> <a href="mailto:admin@sunrise-2025.com" className={link}>admin@sunrise-2025.com</a></p>
          ...
          <div>
            ...
            <div className="space-y-4">
              <div>
                <h3 className={h3}>Personal Data (Direct Collection)</h3>
              ...
              <div>
                <h3 className={h3}>Automatically Collected Data</h3>
                <ul className={`list-disc list-inside space-y-1 ml-4 ${body}`}>
          ...
          <div>
            <h2 className={h2}>3. Legal Basis for Processing (PDPA Compliance)</h2>
          ...
          <div>
            <h2 className={h2}>5. Data Sharing and Third-Party Services</h2>
            <div className="space-y-3">
              <p className={body}>We share data only with your consent or as required by law:</p>
              
              <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
                <h3 className={h3}>Essential Service Providers</h3>
                <ul className={`list-disc list-inside space-y-1 ml-4 ${body}`}>
              ...
              <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
                <h3 className={h3}>Analytics and Marketing</h3>
                <ul className={`list-disc list-inside space-y-1 ml-4 ${body}`}>
          ...
          <div>
            <h2 className={h2}>6. Data Retention Policy</h2>
            <div className="space-y-3">
          ...
          <div>
            <h2 className={h2}>7. Your Data Subject Rights (PDPA)</h2>
            <div className="space-y-3">
              <p className={body}>Under the Personal Data Protection Act 2010, you have the following rights:</p>
              ...
              <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
                ...
                <p className={`${body} text-sm mb-2`}>You can exercise these rights by:</p>
                <ul className={`list-disc list-inside text-sm space-y-1 ml-4 ${body}`}>
                  <li>Using our <a href="/dashboard/data-management" className={link}>Data Management Dashboard</a></li>
                  <li>Emailing us at <a href="mailto:admin@sunrise-2025.com" className={link}>admin@sunrise-2025.com</a></li>
          ...
          <div>
            <h2 className={h2}>10. Cookies and Tracking</h2>
            <div className="space-y-3">
              <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
          ...
          <div>
            <h2 className={h2}>12. Data Breach Notification</h2>
            <p className={body}>
          ...
          <div>
            <h2 className={h2}>14. Complaints and Contact</h2>
            <div className="space-y-3">
              <div className="bg-red-50 border border-red-200 rounded-lg p-4">
                ...
                <ul className="list-disc list-inside text-red-700 text-sm space-y-1 ml-4">
                  <li>Contact us first at <a href="mailto:admin@sunrise-2025.com" className={link}>admin@sunrise-2025.com</a></li>
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                ...
                <div className="text-blue-700 text-sm space-y-1">
                  ...
                  <p><strong>Email:</strong> <a href="mailto:aduan@pdp.gov.my" className={link}>aduan@pdp.gov.my</a></p>
                  <p><strong>Website:</strong> <a href="https://www.pdp.gov.my" target="_blank" rel="noopener noreferrer" className={link}>https://www.pdp.gov.my</a></p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className={borderFoot}>
            <h3 className={h3footer}>Contact Information</h3>
            <div className={`${body} space-y-1`}>
              <p><strong className={isSunset ? "text-foreground" : ""}>Sunrise Sunset Services</strong></p>
              ...
              <p>Email: <a href="mailto:admin@sunrise-2025.com" className={link}>admin@sunrise-2025.com</a></p>
              <p>Data Protection Officer: <a href="mailto:admin@sunrise-2025.com" className={link}>admin@sunrise-2025.com</a></p>
            </div>
          </div>
        </div>
      </div>
