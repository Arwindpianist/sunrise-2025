  ...
  useEffect(() => {
    const checkAdminStatus = async () => {
      ...
      try {
        ...
        const isUserAdmin = userEmail === DASHBOARD_ADMIN_EMAIL
    ...
    checkAdminStatus()
  }, [user, router, session, sessionStatus])
  ...
  const fetchUsers = async () => {
    try {
      ...
      if (!res.ok) {
        ...
        console.error("Error fetching users:", payload)
        toast({
          title: "Error",
          description: payload?.error || "Failed to fetch users",
          variant: "destructive",
        })
        return
      }
          ...
          <Card>
            ...
            <CardContent>
              <div className="space-y-4">
                ...
                {selectedUser && (
                  <div className="grid grid-cols-1 gap-4 rounded-lg border border-border bg-muted/40 p-4 md:grid-cols-2">
                    <div>
                      <h3 className="font-semibold text-sm text-muted-foreground">User Info</h3>
