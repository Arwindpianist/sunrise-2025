...
export default function DataManagementPage() {
  ...
  const fetchDataSummary = async () => {
    try {
      ...
      if (!res.ok) {
        throw new Error(typeof data.error === "string" ? data.error : "Failed to load your data summary")
      }
      ...
      toast({
        title: "Error",
        description: error instanceof Error ? error.message : "Failed to load your data summary",
        variant: "destructive",
      })
    } finally {
      setIsLoading(false)
                ...
                <CardContent>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="space-y-2">
                      <h4 className="font-semibold text-foreground">Account Data</h4>
                      <p className="text-sm text-muted-foreground">Retained while account is active + 2 years after deletion</p>
                      <Badge variant="secondary">Active</Badge>
                    </div>
                    <div className="space-y-2">
                      <h4 className="font-semibold text-foreground">Event Data</h4>
                      <p className="text-sm text-muted-foreground">Retained for 3 years after event date</p>
                      <Badge variant="outline">3 Years</Badge>
                    </div>
                    <div className="space-y-2">
                      <h4 className="font-semibold text-foreground">Contact Data</h4>
                      <p className="text-sm text-muted-foreground">Retained while account is active + 1 year after deletion</p>
                      <Badge variant="outline">1 Year</Badge>
                    </div>
                    <div className="space-y-2">
                      <h4 className="font-semibold text-foreground">Analytics Data</h4>
                      <p className="text-sm text-muted-foreground">Retained for 26 months (Google Analytics standard)</p>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-4">
                      <div>
                        ...
                        <p className="text-foreground">{dataSummary?.account.email}</p>
                      </div>
                      <div>
                        <label className="text-sm font-medium text-foreground">Full Name</label>
                        <p className="text-foreground">{dataSummary?.account.fullName || 'Not provided'}</p>
                      </div>
                    </div>
                    <div className="space-y-4">
                      <div>
                  ...
                  <CardContent>
                    <div className="space-y-3">
                      ...
                      <div className="flex justify-between items-center">
                        ...
                        <Badge variant="outline" className="text-muted-foreground">{dataSummary?.events.past}</Badge>
                      </div>
                    </div>
                  </CardContent>
                </Card>
                  ...
                  <div className="space-y-6">
                    <div className="flex items-center justify-between p-4 border rounded-lg">
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">Receive promotional emails and updates about new features</p>
                      </div>
                      <Button
                    ...
                    <div className="flex items-center justify-between p-4 border rounded-lg">
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">Help us improve our services through usage analytics</p>
                      </div>
                      <Button
                    ...
                    <div className="flex items-center justify-between p-4 border rounded-lg">
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">Allow data sharing with third-party service providers</p>
                      </div>
                      <Button
                    ...
                    <div className="flex items-center justify-between p-4 border rounded-lg">
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">Essential for providing our services (cannot be disabled)</p>
                      </div>
