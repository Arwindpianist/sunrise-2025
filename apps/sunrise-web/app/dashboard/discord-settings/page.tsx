    ...
    return (
      <div className="min-h-screen bg-gradient-to-b from-background via-card/20 to-background flex items-center justify-center">
        <div className="text-center max-w-md mx-auto px-4">
          ...
          <h1 className="text-xl font-semibold text-foreground mb-2">Discord Integration</h1>
          <p className="text-muted-foreground mb-4">
            Discord integration is available for Pro and Enterprise users only.
          </p>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 mb-6 lg:mb-8">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-muted-foreground mt-1 text-sm sm:text-base">Configure your Discord integration</p>
          </div>
        </div>
