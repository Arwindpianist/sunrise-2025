...
export default function Header() {
  ...
  return (
    <header className="bg-white/80 backdrop-blur-md border-b border-gray-200">
      ...
      {/* Custom Mobile Menu - Outside header container for proper overlay */}
      {isMobileMenuOpen && (
        <div className="fixed inset-0 z-50 md:hidden">
          ...
          {/* Navigation Panel */}
          <div className="absolute right-0 top-0 h-full w-[300px] sm:w-[400px] bg-white/90 backdrop-blur-xl border-l border-white/40 shadow-[0_0_30px_rgba(0,0,0,0.1)] relative overflow-hidden animate-in slide-in-from-right duration-300">
