  ...
  const menuContent = (
    <div className="fixed inset-0 z-[9999] md:hidden">
      ...
      />
                ...
                {/* Navigation Panel */}
          <div className={`fixed top-0 right-0 h-full w-[300px] sm:w-[400px] bg-white/90 backdrop-blur-xl border-l border-white/40 shadow-[0_0_30px_rgba(0,0,0,0.1)] relative overflow-hidden transition-all duration-300 ease-out`} style={{ transform: isVisible ? 'translateX(0)' : 'translateX(100%)' }}>
